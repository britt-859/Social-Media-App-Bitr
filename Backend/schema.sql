-- This file will serve as the schema to build out our entire database
...
-- Create a table to store the comments associated with a post
...
-- Create a table that stores the tag usages
